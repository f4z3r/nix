{
  ...
  gruvbox-material-nvim = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      rev = "4cc49a44cba66216793724dba2aa982f95b59955";
      sha256 = "sha256-Pl3fchBh+085cTYNCjPiB5rJiFmR0t1DvHBsMgPw9wU=";
    };
  };
  ...
  yankcraft-nvim = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      repo = "yankcraft.nvim";
      rev = "v0.2.0";
      sha256 = "sha256-m5XoftGwJB2YB7MuVxryYq4dolzZrHlxwJ1KLvkp9HM=";
    };
  };
